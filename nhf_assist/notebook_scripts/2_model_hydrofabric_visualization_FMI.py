...
# %%
fmi_df["flow_management_index"].unique()

# %%
fmi_gage_list = list(set(fmi_df["gageid"]))
npoigages_list = list(poi_df["poi_gage_id"])
common = [x for x in fmi_gage_list if x in npoigages_list]
len(common)
