...
# <font size = '3'> Notebook 2 displays additional NWIS gages NOT listed the parameter file. `waterdata_gage_nobs_min` is used to identify gages from NWIS that have a total number of daily stream observations >= `waterdata_gage_nobs_min`.
