...
#        Date: 2024-05-08
# Description: Configuration class for SNODAS processing
#              YAML is used for the backend
# modified by Adel Haj, 2025-07-31 For nhm-assist application
...
default_values: Dict[str, ConfigElem] = dict(
    root_dir= "",
    subdomain="",
    model_dir="",
    GIS_format="",
...
class Cfg(object):
    ...
    def __init__(self, filename: str, cmdline: Optional[str] = None):
